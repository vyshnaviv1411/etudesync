...
// ✅ FIXED: Rooms joined (ANY participation)
...
if ($totalCreated > $totalJoined) {
    ...
    $styleMsg = 'You actively create and manage collaboration rooms.';
} elseif ($totalJoined > $totalCreated) {
    $collabStyle = 'Active Participant';
    $styleMsg = 'You actively join and collaborate in rooms.';
} else {
    $collabStyle = 'Balanced Collaborator';
    $styleMsg = 'You balance creating and joining collaboration rooms.';
}
...
<div class="collab-card-head" style="align-items:center;gap:16px;">
    ...
    <div>
        ...
        <p class="lead">Your complete collaboration activity summary.</p>
    </div>
</div>
...
<div class="glass-card" style="margin-top:26px;padding:20px;">
    <h3>Room Activity Comparison</h3>
    ...
    <div class="progress-block">
        ...
        <div class="progress-bar">
            <div class="progress-fill created" style="width:<?= $createdPercent ?>%"></div>
        </div>
    </div>
    ...
    <div class="progress-block">
        ...
        <div class="progress-bar">
            <div class="progress-fill joined" style="width:<?= $joinedPercent ?>%"></div>
        </div>
    </div>
</div>
...
<div class="card-grid">
    <div class="card glass-card">
        ...
        <p class="highlight"><?= $collabStyle ?></p>
        <p class="muted"><?= $styleMsg ?></p>
    </div>
    ...
    <div class="card glass-card">
        ...
        <?php if ($recentActivity): ?>
            <p class="highlight"><?= htmlspecialchars($recentActivity['title']) ?></p>
            <p class="muted"><?= date('d M Y, H:i', strtotime($recentActivity['joined_at'])) ?></p>
        <?php else: ?>
...
<div style="margin-top:22px;">
    <a href="collabsphere.php" class="btn primary">← Back to Modules</a>
</div>
